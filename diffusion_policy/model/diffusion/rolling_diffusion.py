...
from .rolling_diffusion_utils import linear_beta_schedule, cosine_beta_schedule, sigmoid_beta_schedule, extract, EinopsWrapper
...
class RollingDiffusion(ModuleAttrMixin):
    ...
    def forward(
        ...
        # prediection type: pred_noise, pred_x0, pred_v
        if self.objective == "pred_noise":
            target = noise
        elif self.objective == "pred_x0":
            target = x
